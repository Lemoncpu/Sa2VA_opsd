...
SAM2_CHECKPOINT="${SAM2_CHECKPOINT:-/mnt/shared-storage-user/dnacoding/wuyucheng/workspace/Nemotrontiaozheng/Sa2VA_opsd/pretrained/sam2/sam21L/sam2_hiera_large.pt}"
