...
train_dataset = dict(
    ...
    repeats=1,
    shuffle=False,
    student_question="<image>Please carefully observe the region marked by region1 and come up with a caption for this region.",
)
...
work_dir = getenv("SA2VA_PUBLIC_2B_WORK_DIR", "./work_dirs/sa2va_opsd_internvl3_2b_v2")
