...
exec env \
  SA2VA_REFCOCO_OPSD_CONFIG="${SA2VA_REFCOCO_OPSD_CONFIG:-projects/sa2va/configs/sa2va_opsd_refcoco_sa2va4b_in25_qwen25_3b_v3.py}" \
  SA2VA_REFCOCO_OPSD_ONLINE_CONFIG="${SA2VA_REFCOCO_OPSD_ONLINE_CONFIG:-projects/sa2va/configs/sa2va_opsd_refcoco_sa2va4b_in25_qwen25_3b_v3_online.py}" \
  SA2VA_REFCOCO_OPSD_DEFAULT_WORK_DIR="${SA2VA_REFCOCO_OPSD_DEFAULT_WORK_DIR:-${ROOT_DIR}/work_dirs/sa2va_opsd_refcoco_sa2va4b_in25_qwen25_3b_v3}" \
