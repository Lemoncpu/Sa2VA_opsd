...
OVERRIDE_SAMPLER_PER_DEVICE_BATCH_SIZE="${SA2VA_REFCOCO_OPSD_OVERRIDE_SAMPLER_PER_DEVICE_BATCH_SIZE:-1}"
DEFAULT_GPUS=8
PYTHON_BIN=""
...
if [[ "${OVERRIDE_SAMPLER_PER_DEVICE_BATCH_SIZE}" == "1" && ( -n "${BATCH_SIZE_OVERRIDE}" || -n "${ACCUMULATIVE_COUNTS_OVERRIDE}" ) ]]; then
...
echo "  TRAIN_FALLBACK_CHAIN=${SA2VA_TRAIN_FALLBACK_CHAIN:-refcoco_opsd_4b}"
...
SA2VA_TRAIN_FALLBACK_CHAIN="${SA2VA_TRAIN_FALLBACK_CHAIN:-refcoco_opsd_4b}" \
