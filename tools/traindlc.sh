...
WORK_DIR="${WORK_DIR:-/mnt/shared-storage-user/dnacoding/wuyucheng/workspace/Nemotrontiaozheng/Sa2VA_opsd/work_dirs/sa2va_opsd_combine_4b_dlc_manifest}"
...
TRAIN_CMD=(
  env
  SA2VA_REFCOCO_OPSD_CONFIG="${SA2VA_REFCOCO_OPSD_CONFIG:-${PROJECT_ROOT}/projects/sa2va/configs/sa2va_opsd_combine_4b_dlc.py}"
  SA2VA_REFCOCO_OPSD_DEFAULT_WORK_DIR="${SA2VA_REFCOCO_OPSD_DEFAULT_WORK_DIR:-${WORK_DIR}}"
  SA2VA_REFCOCO_OPSD_DEFAULT_MODEL_PATH="${SA2VA_REFCOCO_OPSD_DEFAULT_MODEL_PATH:-${MODEL_PATH}}"
  SA2VA_REFCOCO_OPSD_DEFAULT_TOKENIZER_PATH="${SA2VA_REFCOCO_OPSD_DEFAULT_TOKENIZER_PATH:-${TOKENIZER_PATH}}"
  SA2VA_REFCOCO_OPSD_MODEL_FLAVOR="${SA2VA_REFCOCO_OPSD_MODEL_FLAVOR:-sa2va4b}"
  SA2VA_REFCOCO_OPSD_ENTRY_NAME="${SA2VA_REFCOCO_OPSD_ENTRY_NAME:-traindlc.sh}"
  SA2VA_REFCOCO_OPSD_OVERRIDE_SAMPLER_PER_DEVICE_BATCH_SIZE="${SA2VA_REFCOCO_OPSD_OVERRIDE_SAMPLER_PER_DEVICE_BATCH_SIZE:-0}"
  bash "${PROJECT_ROOT}/tools/train_refcoco_opsd_impl.sh"
  --gpus "${JOB_GPU}"
  ...
  -- \
  --cfg-options
  model.type=Sa2VAOPSDCombineModel
  model.train_mode=dlc
)
