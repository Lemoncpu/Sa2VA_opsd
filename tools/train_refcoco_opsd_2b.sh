...
exec env \
  ...
  SA2VA_REFCOCO_OPSD_ONLINE_CONFIG="${SA2VA_REFCOCO_OPSD_ONLINE_CONFIG:-projects/sa2va/configs/sa2va_opsd_refcoco_internvl3_2b_v3_online.py}" \
  ...
  SA2VA_REFCOCO_OPSD_ENTRY_NAME="${SA2VA_REFCOCO_OPSD_ENTRY_NAME:-train_refcoco_opsd_2b.sh}" \
