...
model_path = _getenv("SA2VA_REFCOCO_TEACHER_4B_MODEL_PATH", _join(ROOT_DIR, "pretrained", "Sa2VA-4B"))
tokenizer_path = _getenv("SA2VA_REFCOCO_TEACHER_4B_TOKENIZER_PATH", model_path)
enable_teacher = True
...
iou_high_threshold = float(_getenv("SA2VA_REFCOCO_IOU_HIGH_THRESHOLD", "0.85"))
low_iou_regen_max_new_tokens = int(_getenv("SA2VA_REFCOCO_LOW_IOU_REGEN_MAX_NEW_TOKENS", "48"))
output_dir = _getenv(
    "SA2VA_REFCOCO_TEACHER_4B_OUTPUT_DIR",
    _join(ROOT_DIR, "work_dirs", "refcoco_teacher_context_validation_4b"),
)
